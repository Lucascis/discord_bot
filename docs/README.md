...
Welcome to the Discord Music Bot documentation.
...
### Architecture
- **[Project Structure](PROJECT_STRUCTURE.md)** - Codebase structure and organization
...
- **[Configuration Guide](CONFIGURATION.md)** - Environment and configuration

### Operations
- **[Kubernetes Deployment](KUBERNETES_DEPLOYMENT_GUIDE.md)** - Kubernetes deployment
- **[Multi-Instance Deployment](operations/MULTI_INSTANCE_DEPLOYMENT.md)** - Scaling guide
