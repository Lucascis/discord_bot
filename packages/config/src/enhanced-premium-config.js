...
export const ENHANCED_PREMIUM_FEATURES = {
    free: {
        features: ['sponsor_block'],
        maxAudioQuality: 'standard',
        quotas: {
            queueSize: 50,
...
export function calculatePriceWithPeriod(tier, period) {
    if (tier === 'free')
        return 0;
...
export function getFeaturesByCategory(tier) {
...
export function validateUsageQuota(tier, quota, currentUsage) {
