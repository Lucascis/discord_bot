 ...
 */
export function getLimitValue(limitKey, tier) {
 ...
 */
export function isWithinLimit(currentValue, maxValue) {
    // -1 means unlimited
    if (maxValue === -1)
        return true;
 ...
 */
export function calculateLimitPercentage(currentValue, maxValue) {
 ...
 */
export function calculateNextReset(resetPeriod, from) {
 ...
 */
export function formatLimitValue(value, limitKey) {
    // Unlimited
    if (value === -1) {
        return 'Unlimited';
    }
