...
export class RedisStreamsMonitoring {
  ...
  // Stream metrics
  private streamMessages: Counter<string>;
  private streamPendingMessages: Gauge<string>;
  private commandProcessingDuration: Histogram<string>;
  private consumerErrors: Counter<string>;
  private connectionHealth: Gauge<string>;
  private responseLatency: Histogram<string>;
  private consumerGroupLag: Gauge<string>;
  private activeConsumers: Gauge<string>;

  private monitoringInterval?: NodeJS.Timeout;
  private isInitialized = false;

  constructor(private serviceName: string, private monitoringIntervalMs = 30000) {
   ...
   */
  private async collectStreamInfo(streamName: string): Promise<void> {
    try {
