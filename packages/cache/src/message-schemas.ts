 ...
 */
export function validateVoiceCredentials(data: unknown): VoiceCredentials {
 ...
 */
export function safeValidateVoiceCredentials(data: unknown):
  | { success: true; data: VoiceCredentials }
 ...
 * @throws ZodError if validation fails
 */
export function validateVoiceCredentialsMessage(data: unknown): VoiceCredentialsMessage {
 ...
 */
export function safeValidateVoiceCredentialsMessage(data: unknown):
  | { success: true; data: VoiceCredentialsMessage }
  | { success: false; error: string; details?: unknown } {
  try {
 ...
 */
export function safeValidateCommand(data: unknown):
  | { success: true; data: CommandMessage }
  | { success: false; error: string; details?: unknown } {
  try {
 ...
 * @throws ZodError if validation fails
 */
export function validateLavalinkEvent(data: unknown): LavalinkEventMessage {
 ...
 */
export function safeValidateLavalinkEvent(data: unknown):
  | { success: true; data: LavalinkEventMessage }
  | { success: false; error: string; details?: unknown } {
  try {
 ...
 * @throws ZodError if validation fails
 */
export function validateUIUpdate(data: unknown): UIUpdateMessage {
 ...
 */
export function safeValidateUIUpdate(data: unknown):
  | { success: true; data: UIUpdateMessage }
  | { success: false; error: string; details?: unknown } {
  try {
 ...
 * @throws ZodError if validation fails
 */
export function validateTrackQueued(data: unknown): TrackQueuedMessage {
 ...
 */
export function safeValidateTrackQueued(data: unknown):
  | { success: true; data: TrackQueuedMessage }
  | { success: false; error: string; details?: unknown } {
  try {
 ...
 */
export function validateMessage(data: unknown): { type: string; data: unknown } {
  ...
  if (typeof type === 'string' && ['play', 'playnow', 'playnext', 'skip', 'pause', 'resume', 'toggle', 'stop', 'disconnect', 'volume', 'loop', 'loopSet', 'volumeAdjust', 'nowplaying', 'queue', 'seek', 'seekAdjust', 'shuffle', 'remove', 'clear', 'move', 'seedRelated', 'previous', 'mute', 'filters', 'autoplay'].includes(type as string)) {
    return { type: 'command', data: validateCommand(data) };
  }

  if (obj.guildId && obj.payload && typeof obj.payload === 'object' && 'op' in (obj.payload as object)) {
...
export function safeValidateMessage(data: unknown):
  | { success: true; type: string; data: unknown }
  | { success: false; error: string; details?: unknown } {
  try {
